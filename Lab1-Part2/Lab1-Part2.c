...
void StartTask1(void *argument)
{
  ...
  for(;;)
  {
	  ...
	  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_4, GPIO_PIN_SET);//Green LED
	  if(flag){
		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_4, GPIO_PIN_RESET);//Green LED
		  osDelay(17000);
		  flag = 0;
	  }
...
void StartTask2(void *argument)
{
  ...
  for(;;)
  {
	  ...
	  if (flag){
		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_5, GPIO_PIN_SET);//Orange LED
		  osDelay(3000);
		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_5, GPIO_PIN_RESET);//Orange LED
		  osDelay(12000);
		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_5, GPIO_PIN_SET);//Orange LED
		  osDelay(2000);
		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_5, GPIO_PIN_RESET);//Orange LED
...
void StartTask3(void *argument)
{
  ...
  for(;;)
  {
	  ...
	  if (flag){
		  osDelay(3000);
		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_3, GPIO_PIN_SET);//Red LED
		  osDelay(14000);
		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_3, GPIO_PIN_RESET);//Red LED
	  }
